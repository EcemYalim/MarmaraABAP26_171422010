CLASS z_171422010_work_with_int_tab DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS z_171422010_work_with_int_tab IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    carriers = VALUE #(
      ( carrier_id = 'SQ' currency_code = 'SGD' )
      ( carrier_id = 'JL' currency_code = 'JPY' )
      ( carrier_id = 'AA' currency_code = 'USD' )
    ).

    connection = connections[ carrier_id = 'JL'
                              connection_id = '0408' ].

    connection = connections[ airport_from_id = 'MIA'
                              airport_to_id   = 'HAV' ].
